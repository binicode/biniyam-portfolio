...
export const aboutData = {
  ...
  traits: [
    { label: "Self-Driven", description: "Works independently without hand-holding" },
    { label: "Detail-Oriented", description: "Precision from engineering, applied to code" },
    { label: "Fast Learner", description: "Picks up new technologies quickly" },
    { label: "Problem Solver", description: "Systems thinker with an engineering mindset" },
  ],
